...
wb <- loadWorkbook("plant census 2014-2015.xlsx")
...
write.csv(abundancescurrent,'baldy abundances current 2015 bblonder.csv')
...
drawplot <- function(plotid, dataforyear, prelimseedlingsforyear)
{
	...
	plot(0,0,type='n',xlim=c(-10,210),ylim=c(-10,210))
...
pdf(width=5,height=5,file='census map 2015 with all seedlings.pdf')
par(mar=c(2,2,1,1))
par(cex.axis=0.5)
for (i in 1:50)
{
	drawplot(i, 2015,NULL)
}
dev.off()
